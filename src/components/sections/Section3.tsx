                ...
                <div className="row">
                    <div className="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 align-self-center">
                        <div className="section__title section__title--grid-right">
                            ...
                            <a href="contacts.html" className="section__btn section__btn--grid"><span>Become</span></a>
                        </div>
                    </div>
                    <div className="col-12 col-lg-6 align-self-center">
                        <ul className="sponsors sponsors--small">
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo1.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo2.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo3.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo4.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo5.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo6.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo7.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="img/sponsors/logo8.svg" alt="" />
                                    <span>thesponsor.com</span>
                                </a>
                            </li>
                        </ul>
