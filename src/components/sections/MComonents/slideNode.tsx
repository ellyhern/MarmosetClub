    ...
    return (
        <li className="splide__slide" key={3} onDragStart={handleDragStart}>
            <div className="hero__content hero__content--left hero__content--slider">
                <span className="hero__tagline">Free to play</span>
                ...
                <div className="hero__btns hero__btns--left">
                    <a href="#" className="hero__btn"><span>Play</span></a>
                    <a href="/game" className="hero__btn hero__btn--nephrite"><span>Read more</span></a>
                </div>
                <div className="game game--cover">
                    ...
                    <ul className="game__list">
                        ...
                        <li>
                            Free to play <span className="true">{slideinfo.freetoplay}</span>
                        </li>
                        <li>
