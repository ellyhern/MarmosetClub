        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
              ...
              <p>Play to Earn GameFi Aggregator.</p>
              <p>Experience an innovative gaming ecosystem where you can both play and earn.</p>

              <div className="footer__lang">
                <a className="footer__lang-btn" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div className="row">
            <div className="col-12">
              <div className="footer__content">
                <div className="footer__social">
                  ...
                  <a href="https://www.facebook.com/" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M20.9,2H3.1A1.1,1.1,0,0,0,2,3.1V20.9A1.1,1.1,0,0,0,3.1,22h9.58V14.25h-2.6v-3h2.6V9a3.64,3.64,0,0,1,3.88-4,20.26,20.26,0,0,1,2.33.12v2.7H17.3c-1.26,0-1.5.6-1.5,1.47v1.93h3l-.39,3H15.8V22h5.1A1.1,1.1,0,0,0,22,20.9V3.1A1.1,1.1,0,0,0,20.9,2Z" /></svg></a>
                  ...
                  <a href="https://t.me/+q-0NJPZlvX81Yzlk" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  ...
                  <a href="https://discord.gg/35NbEJZP" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <small>&copy; Aleph, 2022-2023. Created by &nbsp;
                  <a href="https://contador11-azeronode.com/portada-2/" target="_blank" rel="noopener noreferrer">contador11</a>.
                </small>
              </div>
            </div>
          </div>
